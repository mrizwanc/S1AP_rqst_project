...
asn_TYPE_member_t asn_MBR_E_RABSetupItemBearerSURes_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct E_RABSetupItemBearerSURes, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5589P7,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_E_RABSetupItemBearerSURes_specs_1 = {

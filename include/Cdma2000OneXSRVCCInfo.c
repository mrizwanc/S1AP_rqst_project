...
asn_TYPE_member_t asn_MBR_Cdma2000OneXSRVCCInfo_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct Cdma2000OneXSRVCCInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5589P24,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_Cdma2000OneXSRVCCInfo_specs_1 = {
